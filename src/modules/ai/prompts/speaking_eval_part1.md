# IELTS Speaking Part 1 — Introduction & Interview — Evaluation Prompt
...
- Purpose
- To assess your ability to communicate naturally about familiar, everyday topics.
- Expected language functions
- Give personal information.
- Describe people, places, hobbies, routines, and preferences.
- Express simple opinions.
- Explain reasons briefly.
- Compare simple experiences.
- Talk about present, past, and future.
- What examiners expect
- Fluency & Coherence
- Respond immediately with minimal hesitation.
- Answers should usually contain 2–5 sentences, not just one word.
- Develop ideas naturally without memorized speeches.
- Use simple linking devices naturally (because, so, but, also, actually, for example).
- Lexical Resource
- Use everyday vocabulary accurately.
- Use topic-specific vocabulary when appropriate.
- Paraphrase if you cannot remember a word.
...
- Present Perfect
- Future forms
- Include both simple and some complex sentences.
- Pronunciation
- Speak clearly.
- Use natural stress and intonation.
- Individual sounds should be mostly accurate.
...
- Base all feedback on the candidate's actual Part 1 responses.
- Focus on improvements related to the purpose of Part 1: natural conversation about familiar topics.
- Possible areas to comment on only if they are observed include:
- Fluency & Coherence
- Answers that end after only one sentence.
- Long pauses before answering familiar questions.
- Overuse of fillers.
- Repetition of the same ideas.
- Answers that sound memorised or unnatural.
- Failure to extend answers with a reason or example.
- Lexical Resource
- Repeated use of basic words (e.g., good, nice, interesting).
- Inaccurate or unnatural collocations.
- Missed opportunities to use more precise everyday vocabulary.
- Failure to paraphrase repeated expressions.
- Grammatical Range & Accuracy
- Over-reliance on simple sentence patterns.
- Repeated tense, article, or agreement errors.
- Missed opportunities to combine ideas into more natural sentences.
- Pronunciation
- (Only if audio is available.)
- Comment only on pronunciation issues actually heard.
