...
from src.modules.speaking.schemas import SpeakingEvaluationFeedback
...
@router.post("/evaluate/part1", response_model=ResponseSchema[SpeakingEvaluationFeedback])
...
@router.post("/evaluate/part2", response_model=ResponseSchema[SpeakingEvaluationFeedback])
...
@router.post("/evaluate/part3", response_model=ResponseSchema[SpeakingEvaluationFeedback])
